...
export const STEPS = [
  ...
  },
  {
    ...
    notes: [
      ...
      'Access control: badge readers on the entrance arches. Who, or which agent, can do what, where, for how long.',
      '(Press) Quality gates: a gate between every pair of stations. Work does not move on until its output meets the definition of done.',
      '(Press) Decision rules: sign-off masts on the mixed rooms, Design, Verify, Measure. They encode when a human must sign and when an agent may proceed.',
      '(Press) Audit: every verdict and sign-off streams into the ledger, recorded and replayable.',
